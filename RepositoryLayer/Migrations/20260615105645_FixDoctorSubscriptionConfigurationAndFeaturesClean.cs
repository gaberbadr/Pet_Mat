...
{
    /// <inheritdoc />
    public partial class FixDoctorSubscriptionConfigurationAndFeaturesClean : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    HasPasswordAsync = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SpeciesId = table.Column<int>(type: "int", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", maxLength: 200, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AccessoryListings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AccessoryListings_AspNetUsers_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AccessoryListings_Species_SpeciesId",
                        column: x => x.SpeciesId,
                        principalTable: "Species",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NationalIdFront = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    NationalIdBack = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    SelfieWithId = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    SyndicateCard = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    MedicalLicense = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    Status = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsAvailableForConsultation = table.Column<bool>(type: "bit", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PharmacyLicenseDocument = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    OwnerNationalIdFront = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    OwnerNationalIdBack = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    SelfieWithId = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    SyndicateCard = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    Status = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    AppliedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PharmacyApplications", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PharmacyApplications_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_PharmacyProfiles_UserId", x => x.UserId);
                    table.ForeignKey(
                        name: "FK_PharmacyProfiles_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DoctorRatings_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DoctorSubscriptions_DoctorProfiles_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "DoctorProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DoctorSubscriptions_SubscriptionPackage_PackageId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PharmacyListings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PharmacyListings_AspNetUsers_PharmacyId",
                        column: x => x.PharmacyId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PharmacyListings_PharmacyProfiles_PharmacyProfileId",
                        column: x => x.PharmacyProfileId,
                        principalTable: "PharmacyProfiles",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PharmacyListings_Species_SpeciesId",
                        column: x => x.SpeciesId,
                        principalTable: "Species",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductAvailabilityRating = table.Column<int>(type: "int", nullable: false),
                    PricingRating = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PharmacyRatings_AspNetUsers_PharmacyId",
                        column: x => x.PharmacyId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PharmacyRatings_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AnimalListings_Animals_AnimalId",
                        column: x => x.AnimalId,
                        principalTable: "Animals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AnimalListings_AspNetUsers_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccessoryListings_Category",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccessoryListings_OwnerId",
                table: "AccessoryListings",
                column: "OwnerId");

            migrationBuilder.CreateIndex(
                name: "IX_AccessoryListings_SpeciesId",
                table: "AccessoryListings",
                column: "SpeciesId");

            migrationBuilder.CreateIndex(
                name: "IX_AccessoryListings_Status",
                table: "AccessoryListings",
                column: "Status");

            migrationBuilder.CreateIndex(
                name: "IX_AnimalListings_AnimalId",
                table: "AnimalListings",
                column: "AnimalId");

            migrationBuilder.CreateIndex(
                name: "IX_AnimalListings_CreatedAt",
                table: "AnimalListings",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_AnimalListings_OwnerId",
                table: "AnimalListings",
                column: "OwnerId");

            migrationBuilder.CreateIndex(
                name: "IX_AnimalListings_Status",
                table: "AnimalListings",
                column: "Status");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DoctorApplications_Status",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DoctorProfiles_Latitude_Longitude",
                table: "DoctorProfiles",
                columns: new[] { "Latitude", "Longitude" });

            migrationBuilder.CreateIndex(
                name: "IX_DoctorProfiles_Specialization",
                table: "DoctorProfiles",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DoctorRatings_DoctorId_UserId",
                table: "DoctorRatings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DoctorSubscriptions_IsActive",
                table: "DoctorSubscriptions",
                column: "IsActive");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DoctorSubscriptions_PaymentIntentId",
                table: "DoctorSubscriptions",
                column: "PaymentIntentId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_DoctorSubscriptions_Status",
                table: "DoctorSubscriptions",
                column: "Status");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PharmacyApplications_Status",
                table: "PharmacyApplications",
                column: "Status");

            migrationBuilder.CreateIndex(
                name: "IX_PharmacyApplications_UserId",
                table: "PharmacyApplications",
                column: "UserId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PharmacyListings_Category",
                table: "PharmacyListings",
                column: "Category");

            migrationBuilder.CreateIndex(
                name: "IX_PharmacyListings_IsActive",
                table: "PharmacyListings",
                column: "IsActive");

            migrationBuilder.CreateIndex(
                name: "IX_PharmacyListings_PharmacyId",
                table: "PharmacyListings",
                column: "PharmacyId");

            migrationBuilder.CreateIndex(
                name: "IX_PharmacyListings_PharmacyProfileId",
                table: "PharmacyListings",
                column: "PharmacyProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_PharmacyListings_SpeciesId",
                table: "PharmacyListings",
                column: "SpeciesId");

            migrationBuilder.CreateIndex(
                name: "IX_PharmacyProfiles_IsActive",
                table: "PharmacyProfiles",
                column: "IsActive");

            migrationBuilder.CreateIndex(
                name: "IX_PharmacyProfiles_Latitude_Longitude",
                table: "PharmacyProfiles",
                columns: new[] { "Latitude", "Longitude" });

            migrationBuilder.CreateIndex(
                name: "IX_PharmacyProfiles_UserId",
                table: "PharmacyProfiles",
                column: "UserId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubscriptionPackage_IsActive",
                table: "SubscriptionPackage",
                column: "IsActive");

            migrationBuilder.CreateIndex(
                name: "IX_SubscriptionPackage_Name",
                table: "SubscriptionPackage",
                column: "Name");

            migrationBuilder.CreateIndex(
                name: "IX_SubSpecies_Name_SpeciesId",
                table: "SubSpecies",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserConnections_IsActive",
                table: "UserConnections",
                column: "IsActive");
