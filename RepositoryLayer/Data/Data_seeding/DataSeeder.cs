...
namespace RepositoryLayer.Data.Data_seeding
{
    public static class DataSeeder
    {
        ...
        {
            var existing = await unitOfWork.Repository<DeliveryMethod, int>().GetAllAsync();
            if (!existing.Any())
            {
        ...
        {
            var existing = await unitOfWork.Repository<ProductBrand, int>().GetAllAsync();
            if (!existing.Any())
            {
        ...
        {
            var existing = await unitOfWork.Repository<ProductType, int>().GetAllAsync();
            if (!existing.Any())
            {
